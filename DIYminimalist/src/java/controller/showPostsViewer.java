...
@WebServlet(name = "showPostsViewer", urlPatterns = {"/showPostsViewer"})
public class showPostsViewer extends HttpServlet {
            ...
            if (rs != null) {
                try {
                    ...
                    try {
                        ...
                        RequestDispatcher rd = request.getRequestDispatcher("viewer_home.jsp");
